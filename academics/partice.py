...
class ResultSerializer(serializers.ModelSerializer):
    ...
    student_id = serializers.CharField(source ='exam.name', read_only = True)
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    def get_pending_submissin(self, obj):
        from students.models import Student
        total_students = Student.object.filter(grade = obj.course.grade,is_active = True).count()
    ...
    def get_percentage(self, obj):
        if obj.marks_obtained and obj.assigment.total_marks:
